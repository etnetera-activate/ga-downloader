const optionDefinitions = [{
    ...
    },
    {
        name: 'segment',
        type: String,
        typeLabel: '{underline segmentString}',
        description: 'segment definition. Example: "sessions::condition::ga:medium==referral"',
        group: 'optional'
    },
    {
        name: 'filters',
        type: String,
        typeLabel: '{underline filtersStting}',
        description: 'filters definition. Example: "ga:medium==email;ga:productSKU=~1245"',
        group: 'optional'
    },
    {
        name: 'authFile',
